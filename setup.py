...
setup(
    ...
    description="Media management structures for Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-structures-media',
    project_urls={
        'Documentation': 'https://tendril-structures-media.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-structures-media/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-structures-media',
    },
